    ...
    <div className="relative bg-black overflow-hidden] bg-cover bg-center">
      <Container className="h-[80vh]">
        <video
          ...
          loop
          playsInline
          className="absolute z-[2] left-0 top-0 w-full h-full object-cover opacity-40"
        />
        <div className="relative h-full grid items-center text-white z-[2] ">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-6 mt-4 items-center">
              <Link
                href="#pricing"
                className="py-2 px-4 bg-red-500 font-semibold rounded-xs md:text-lg hover:scale-105 transition-all cursor-pointer"
              >
                Pricing
              </Link>
