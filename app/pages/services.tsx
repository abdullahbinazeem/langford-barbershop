  ...
  return (
    <div className="bg-white text-black py-20 md:px-0 px-4">
      <Container className="items-center">
        <h1 className="text-transparent text-nowrap bg-clip-text bg-gradient-to-r from-red-500 via-red-400 to-blue-400 ml-[50%] translate-x-[-50%] inline-block uppercase font-extrabold  text-3xl sm:text-4xl lg:text-6xl leading-tight">
          Our Services
        </h1>
